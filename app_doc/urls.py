...
urlpatterns = [
    ...
    path('genera_project_file/', views.genera_project_file,
         name='genera_project_file'),  # 个人中心生成文集文件（epub\docx\pdf等）
    path('report_project_file/', views.report_file,
         name='report_file'),  # 导出文集文件(epub、docx等)
    path('modify_pro_role/<int:pro_id>/', views.modify_project_role,
         name="modify_pro_role"),  # 修改文集权限
    ...
    path('manage_project_colla/<int:pro_id>/',
         views.manage_project_collaborator, name="manage_pro_colla"),  # 管理文集协作
    path('manage_pro_colla_self/', views.manage_pro_colla_self,
         name="manage_pro_colla_self"),  # 我协作的文集
    # 文档相关
    ...
    path('diff_doc/<int:doc_id>-<int:his_id>/',
         views.diff_doc, name='diff_doc'),  # 对比文档历史版本
    path('manage_doc_history/<int:doc_id>/', views.manage_doc_history,
         name='manage_doc_history'),  # 管理文档历史版本
    ...
    # 文档模板相关
    path('manage_doctemp/', views.manage_doctemp,
         name='manage_doctemp'),  # 文档模板列表
    path('create_doctemp/', views.create_doctemp,
         name="create_doctemp"),  # 创建文档模板
    ...
    path('modify_doctemp/<int:doctemp_id>/',
         views.modify_doctemp, name="modify_doctemp"),  # 修改文档模板
    # 文件管理相关
