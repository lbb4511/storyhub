...
class Doc(models.Model):
    ...
    status = models.IntegerField(
        choices=((0, 0), (1, 1)), default=1, verbose_name='文档状态')
...
class DocHistory(models.Model):
    ...
    pre_content = models.TextField(
        verbose_name='文档历史编辑内容', null=True, blank=True)
...
class ProjectReportFile(models.Model):
    ...
    file_type = models.CharField(choices=(
        ('epub', 'epub'), ('pdf', 'pdf'), ('docx', 'docx')), verbose_name='文件类型', max_length=10)
...
class ImageGroup(models.Model):
    ...
    group_name = models.CharField(
        verbose_name="图片分组", max_length=50, default="默认分组")
...
class Image(models.Model):
    ...
    file_name = models.CharField(
        verbose_name="图片名称", max_length=250, null=True, blank=True)
    group = models.ForeignKey(
        ImageGroup, on_delete=models.SET_NULL, null=True, verbose_name="图片分组")
    remark = models.CharField(
        verbose_name="图片备注", null=True, blank=True, max_length=250, default="图片描述")
...
class Attachment(models.Model):
    file_name = models.CharField(
        max_length=200, verbose_name="附件名", default='storyhub_附件.zip')
